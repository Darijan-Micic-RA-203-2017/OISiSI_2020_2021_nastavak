...
public class ProfessorsController {
	...
	public void addProfessor() {
		ProfessorsCollection.getInstance().addProfessor("Kovacevic","Miodrag",LocalDate.of(1982, 10, 10),
				"Desanke Maksimovic 32, Kragujevac", "0613214457", "miodrag__kovacevic@yahoo.com",
				"Vuka Karadzica 87, Beograd",1010982,TitleOfProfessor.DR,CallingOfProfessor.REDOVNI_PROFESOR);
	...
	public void modifyProfessor(int rowSelectedIndex) {
		if(rowSelectedIndex >= 0) {
			...
			ProfessorsCollection.getInstance().modifyProfessor("Ilijev", "Ivana", LocalDate.of(1989, 7, 8),
					"Branislava Nusica 91, Beograd", "0639076833", "ivkailijev@gmail.com", 
