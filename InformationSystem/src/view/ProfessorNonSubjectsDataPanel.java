...
public class ProfessorNonSubjectsDataPanel extends JPanel {
	...
	public ProfessorNonSubjectsDataPanel(String typeOfParentDialog, int selectedRowIndex) {
		professorDataEntryListener = 
				new ProfessorDataEntryListener(this, typeOfParentDialog, selectedRowIndex);
